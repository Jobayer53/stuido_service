    ...
    <div class="row mt-3 ">
        <div class="col-lg-6 m-auto ">
            @if ($service->available == 1)
                <div class="card">
                    <h5 class="card-header text-center">এক ক্লিকে সাইন টু স্মার্ট এনআইডি ডাউনলোড</h5>
                    <div class="card-body">
    ...
    <div class="row p-2">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('api_signToSmrtNid_download') }}" id="nid_form" enctype="multipart/form-data"
                        ...
                        <div class="mb-1 text-center nid ">
                            <p class="">তথ্য দিয়ে স্মার্ট এনআইডি ডাউনলোড @if ($autoSmrtNid->available == 0)
                                    বন্ধ আছে!
                                @else
                                    করুন
                                    <span class="text-danger">{{ number_format($autoSmrtNid->cost, 0) }} টাকা </span>
                                @endif
                            </p>
                        </div>
