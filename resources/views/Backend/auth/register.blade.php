          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <p class="text-center mt-1 mb-4">This is an <span class="text-danger">one time</span> registration. </p>
                <form action="{{route('admin_register_store')}}" method="POST">
                  @csrf
                  <div class="mb-3">
                    <label for="exampleInputtext1" class="form-label">Name</label>
                    <input type="text" class="form-control" id="exampleInputtext1" aria-describedby="textHelp" name="name" value="{{ old('name') }}" autofocus>
                  </div>
                  <div class="mb-3">
