            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="  d-flex justify-content-between">
                        <h5>Lost NID</h5>
                        <h5 class="float-end">Cost:{{ $lost_nid->cost }}</h5>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="w-20">
                                            ...
                                            @if (!$isCompleted && !$isCancelled)
                                                <form action="{{ route('admin_file') }}" method="POST" class="fileForm"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <textarea name="" class="form-control" id="showData" cols="40" rows="15" readonly></textarea>
                </div>
